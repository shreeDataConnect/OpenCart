...
public class BaseClass
{
    ...
    public void setUp(String os,String br) throws IOException {
        ...
        p=new Properties();
        p.load(file);
        //Loading log4j2.xml for writing logs
        ...
        // Without hard coding and getting URL from config.properties file - appURL variable
    ...
    // Capturing screenshot with time stamp and folder path
